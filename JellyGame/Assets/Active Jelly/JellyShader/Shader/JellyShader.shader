Shader "Custom/JellyShader"
{
	...
	SubShader
	{
		...
		UsePass "Custom/JellyShaderHelper/GRAB_SHARED_FWD"
		...
		Pass
		{
			...
			#include "Inc/Forward/JellyForwardBaseSetup.cginc"
			#include "Inc/Forward/JellyForward.cginc"
		...
		Pass
		{
			...
			#include "Inc/Forward/JellyForwardAddSetup.cginc"
			#include "Inc/Forward/JellyForward.cginc"
		...
		Pass
		{
			...
			#include "Inc/Meta/JellyMetaSetup.cginc"
			#include "Inc/Meta/JellyMeta.cginc"
			ENDCG
		}
    }
	...
	SubShader
	{
		...
		//Get shared refraction
		UsePass "Custom/JellyShaderHelper/GRAB_SHARED_FWD"
		UsePass "Custom/JellyShaderHelper/GRAB_SHARED_VRTLT"
		UsePass "Custom/JellyShaderHelper/GRAB_SHARED_VRTLTLM"
		UsePass "Custom/JellyShaderHelper/GRAB_SHARED_VRTLTLMRGBM"

		/////////////////////////////////////////////////////////////////////////////////////////////
		// VERTEX LIT
		/////////////////////////////////////////////////////////////////////////////////////////////
		UsePass "Custom/JellyShaderHelper/VERTEXNLM_LIT"
		UsePass "Custom/JellyShaderHelper/VERTEXLM_LIT"
		UsePass "Custom/JellyShaderHelper/VERTEXLMRGBM_LIT"
