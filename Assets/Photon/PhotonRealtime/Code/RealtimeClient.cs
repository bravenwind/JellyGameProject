...
namespace Photon.Realtime
{
    ...
    public partial class RealtimeClient : IPhotonPeerListener
    {
        ...
        /// <remarks>Any region pinging in progress gets aborted (which suppresses the ping-completed callback), no matter which cause led here.</remarks>
        ...
        public virtual void OnStatusChanged(StatusCode statusCode)
        {
            switch (statusCode)
            {
                ...
                case StatusCode.Disconnect:
                    ...
                    this.AbortRegionPinging();  // covers server-side and timeout disconnects, which don't go through this.Disconnect(cause)
                    this.friendListRequested = null;
