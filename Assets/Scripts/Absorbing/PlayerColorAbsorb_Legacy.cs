...
public class PlayerColorAbsorb_Legacy : MonoBehaviour
{
    ...
    //    // 배열 범위 초과 방지
    //    int levelIndex = Mathf.Clamp(DataManager.Instance.playerCurrentLevel - 1, 0, DataManager.Instance.scaleMultiplyPerLevel.Length - 1);
    //    Vector3 targetScale = startScale * DataManager.Instance.scaleMultiplyPerLevel[levelIndex];
