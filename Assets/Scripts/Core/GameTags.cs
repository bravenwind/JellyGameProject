...
public static class GameTags
{
    ...
    //
    //   이 규칙의 원조는 Milk와 PuddingWiggle이다 — 예전부터 PlayerMesh 태그로 하나만
    //   골라 받고 있었다. 그걸 함수로 뽑아 전부에 적용했는데, 한동안 <b>원조 두 곳만
    //   여전히 CompareTag를 직접 부르고</b> 있었다. 규칙을 만들면서 그 규칙이 나온 자리를
    //   빠뜨린 셈이다. 지금은 태그 문자열을 아는 곳이 이 파일 하나다.
    //
